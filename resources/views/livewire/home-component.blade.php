            ...
            <div class="slide-carousel owl-carousel style-nav-1" data-items="1" data-loop="1" data-nav="true" data-dots="false">
                ...
                <div class="item-slide">
                    ...
                    <div class="slide-info slide-1">
                        ...
                        <p class="sale-info"><b>Only price: <span class="price">${{$slider->price}}</span></b></p>
                ...
                <div class="product product-style-2 equal-elem ">
                    <div class="product-thumnail">
                        <a href="{{route('product.details',$sale_product->slug)}}" title="{{$sale_product->name}}">
                            <figure><img src="{{asset('assets/images/products')}}/{{$sale_product->image}}" width="800" height="800" alt=""></figure>
                        </a>
                    ...
                    <div class="tab-contents">
                        <div class="tab-content-item active" id="digital_1a">
                            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}' >
                                ...
                                <div class="product product-style-2 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{route('product.details',$latestProduct->slug)}}" title="{{$latestProduct->name}}">
                                            <figure><img src="{{asset('assets/images/products')}}/{{$latestProduct->image}}" width="800" height="800" alt="{{$latestProduct->slug}}"></figure>
                                        </a>
                                    </div>
                                    <div class="product-info">
                                        <a href="{{route('product.details',$latestProduct->slug)}}" class="product-name"><span>{{$latestProduct->name}}</span></a>
